...
#define kDefaultBackImageName @"navgationBackgroundImage"
...
- (void)navigationController:(UINavigationController *)navigationController didShowViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (viewController.jt_fullScreenPopGestureEnabled) {
        ...
        BOOL isForbidCeHua = [[NSUserDefaults standardUserDefaults] boolForKey:@"forbidCeHua"];
        if (isForbidCeHua==YES) {
            [self.view removeGestureRecognizer:self.popPanGesture];
            self.interactivePopGestureRecognizer.delegate = self.popGestureDelegate;
            self.interactivePopGestureRecognizer.enabled = NO;
        } else {
